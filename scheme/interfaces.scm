...
(define-interface locations-interface
  (export location?
	  ...
	  location-id
	  set-location-id!
	  location-uid			; Kali code
	  set-location-uid!		; Kali code
...
(define-interface templates-interface
  (export make-template
	  ...
	  template-overhead
	  set-template-code!
	  template-id set-template-id!	; Kali code
	  set-template-info!
	  template-set!
	  template?))
