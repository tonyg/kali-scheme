...
(define proxy->       (input-type proxy?         no-coercion))	; Kali code
(define proxy-data->  (input-type proxy-data?    no-coercion))	; Kali code
(define aspace->      (input-type address-space? no-coercion))	; Kali code
