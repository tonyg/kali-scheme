...
(define location-size 3)		; Kali change, was 2
(define location-id-offset       0)
(define location-uid-offset      1)	; Kali code
(define location-contents-offset 2)	; Kali change, was 1

(define symbol-size 2)			; Kali change, was 1
