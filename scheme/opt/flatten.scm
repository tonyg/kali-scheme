...
; This is turned off because the debugger gets confused by mixtures of flat
; and non-flat environments.  If you want to use flat environments you need
; to change the first line of COMPILE-FORM in bcomp/comp.scm to
;
;  (let ((node (flatten-form (force-node node))))
;
; and add FLATTEN to the module opened by the compiler module in
; comp-modules.scm.
;
; The debugger needs to be changed as well.
