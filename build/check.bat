...
echo (define-test-suite all-tests (compiler-tests big-tests misc-tests tcp-sockets-tests udp-sockets-tests r6rs-tests cml-tests portable-srfi-tests)) >> check.input
