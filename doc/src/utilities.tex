...
\code{Delq} removes all elements \code{eq?} to \var{value}.  DELQ!
...
\begin{protos}
  ...
  \protonoresult{vector-merge!}{ $<$ v v$_1$ v$_2$ [start [start$1$ [end$1$ [start$2$ [end$2$]]]]]}
  \proto{vector-sort}{ $<$ v [start [end]]}{vector}
  \protonoresult{vector-sort!}{ $<$ v [start [end]]}
  \proto{vector-stable-sort}{ $<$ v [start [end]]}{vector}
  \protonoresult{vector-stable-sort!}{ $<$ v [start [end]]}
...
\begin{protos}
  ...
  \protonoresult{vector-merge-sort!}{ $<$ vector [start [end [temp]]]}
  \proto{vector-merge}{ $<$ vector$_1$ vector$_2$ [start$_1$ [end$_1$ [start$_2$ [end$_2$]]]]}{vector}
  \protonoresult{vector-merge!}{ $<$ vector vector$_1$ vector$_2$ [start [start$_1$ [end$_1$ [start$_2$ [end$_2$]]]]]}
\end{protos}
%
...
\protonoresult{vector-heap-sort!}{ $<$ vector [start [end]]}
\end{protos}
%
...
\protonoresult{vector-insert-sort!}{ $<$ vector [start [end]]}
\end{protos}
%
...
\begin{protos}
  ...
  \proto{vector-delete-neighbor-dups!}{ $=$ vector [start [end]]}{end$'$}
\end{protos}
%
