...
static s48_error_t
s48_new_provide_asm_values (s48_word_t * result,
                            s48_arena_t arena,
                            s48_word_t * asm_vector)
{
  *result = s48_provide_asm_values (*asm_vector);
  return 0;
}
...
static s48_error_t
s48_new_malloc_byte_vector (s48_word_t * result,
                            s48_arena_t arena,
                            s48_word_t * length)
{
  *result = s48_malloc_byte_vector (*length);
  return 0;
}
...
static s48_error_t
s48_new_free_byte_vector (s48_word_t * result,
                          s48_arena_t arena,
                          s48_word_t * byte_vector)
{
  *result = s48_free_byte_vector (*byte_vector);
  return 0;
}
...
static s48_error_t
s48_new_stob_start_address (s48_word_t * result,
                            s48_arena_t arena,
                            s48_word_t * stob)
{
  *result = s48_stob_start_address (*stob);
  return 0;
}
