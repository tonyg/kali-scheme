...
#define s48_va_end ((s48_word_t *)0)
...
#include "scheme48/libscheme48/external.h"
#include "scheme48/libscheme48/stobs.h"
...
#include "scheme48/libscheme48/boxing.h"
...
#include "scheme48/libscheme48/locals.h"

/* Exceptions */

extern void s48_raise_scheme_exception(long type, long nargs, ...);

#include "scheme48/libscheme48/exceptions.h"
...
#define S48_UNSAFE_EXTRACT_CHAR(x) ((unsigned char)((x) >> 8))
...
#define S48_EXCEPTION_ILLEGAL_EXCEPTION_RETURN 28
