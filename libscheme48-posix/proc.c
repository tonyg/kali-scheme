...
static s48_value make_pid(pid_t c_pid);

static s48_error_t
new_make_pid (s48_word_t * result,
              s48_arena_t arena,
              pid_t c_pid)
{
  *result = make_pid (c_pid);
  return 0;
}
...
static s48_value lookup_pid(pid_t c_pid);

static s48_error_t
new_lookup_pid (s48_word_t * result,
                s48_arena_t arena,
                pid_t c_pid)
{
  *result = lookup_pid (c_pid);
  return 0;
}
...
s48_error_t
s48_new_enter_pid (s48_word_t * result,
                   s48_arena_t arena,
                   pid_t c_pid)
{
  *result = s48_enter_pid (c_pid);
  return 0;
}
...
static s48_error_t
new_posix_enter_pid (s48_word_t * result,
                     s48_arena_t arena,
                     s48_word_t * sch_pid)
{
  *result = posix_enter_pid (*sch_pid);
}
...
static s48_error_t
new_posix_waitpid (s48_word_t * result,
                   s48_arena_t arena)
{
  *result = posix_waitpid ();
}
...
static s48_error_t
new_posix_fork (s48_word_t * result,
                s48_arena_t arena)
{
  *result = posix_fork ();
  return 0;
...
static s48_error_t
new_posix_exec (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * program,
                s48_word_t * lookup_p,
                s48_word_t * env,
                s48_word_t * args)
{
  *result = posix_exec (*program, *lookup_p, *env, *args);
  return 0;
}
...
s48_error_t
new_posix_kill (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * sch_pid,
                s48_word_t * sch_signal)
{
  *result = posix_kill (*sch_pid, *sch_signal);
  return 0;
}
...
signal_map_init()
{
#include "scheme48/libscheme48-posix/s48_signals.h"
}
...
static s48_error_t
new_posix_initialize_named_signals (s48_word_t * result,
                                    s48_arena_t arena)
{
  *result = posix_initialize_named_signals ();
  return 0;
}
...
static s48_value make_unnamed_signal(s48_value fx_signal);

static s48_error_t
new_make_unnamed_signal (s48_word_t * result,
                         s48_arena_t arena,
                         s48_word_t * fx_signal)
{
  *result = make_unnamed_signal (*fx_signal);
  return 0;
}
...
s48_error_t
new_posix_request_interrupts (s48_word_t * result,
                              s48_arena_t arena,
                              s48_word_t * sch_signum)
{
  *result = posix_request_interrupts (*sch_signum);
  return 0;
}
...
s48_error_t
new_posix_cancel_interrupt_request (s48_word_t * result,
                                    s48_arena_t arena,
                                    s48_word_t * sch_signum)
{
  *result = posix_cancel_interrupt_request (*sch_signum);
  return 0;
}
