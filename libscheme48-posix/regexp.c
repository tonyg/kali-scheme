 ...
 */
static s48_error_t
new_posix_compile_regexp (s48_word_t * result,
                          s48_arena_t arena,
                          s48_word_t * pattern,
                          s48_word_t * extended_p,
                          s48_word_t * ignore_case_p,
                          s48_word_t * submatches_p,
                          s48_word_t * newline_p)
{
  *result = posix_compile_regexp (*pattern, *extended_p, *ignore_case_p, *submatches_p, *newline_p);
  return 0;
}
...
static s48_error_t
new_posix_regexp_match (s48_word_t * result,
                        s48_arena_t arena,
                        s48_word_t * sch_regex,
                        s48_word_t * string,
                        s48_word_t * sch_start,
                        s48_word_t * submatches_p,
                        s48_word_t * bol_p,
                        s48_word_t * eol_p)
{
  *result = posix_regexp_match (*sch_regex, *string, *sch_start, *submatches_p, *bol_p, *eol_p);
  return 0;
}
...
static s48_error_t
new_posix_regexp_error_message (s48_word_t * result,
                                s48_arena_t arena,
                                s48_word_t * pattern,
                                s48_word_t * extended_p,
                                s48_word_t * ignore_case_p,
                                ...
                                s48_word_t * newline_p)
{
  *result = posix_regexp_error_message (*pattern, *extended_p, *ignore_case_p, *submatches_p, *newline_p);
  return 0;
}
...
static s48_error_t
new_posix_free_regexp (s48_word_t * result,
                       s48_arena_t arena,
                       s48_word_t * sch_regex)
{
  *result = posix_free_regexp (*sch_regex);
  return 0;
}
