...
#include "scheme48/libprescheme/fd-io.h"		/* ps_close_fd() */
#include "scheme48/libscheme48/event.h"		/* add_pending_fd() */
...
static s48_error_t
s48_new_socket (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * udp_p,
                s48_word_t * input_p)
{
  *result = s48_socket (*udp_p, *input_p);
  return 0;
}
...
static s48_error_t
s48_new_bind (s48_word_t * result,
              s48_arena_t arena,
              s48_word_t * channel,
              s48_word_t * port_number)
{
  *result = s48_bind (*channel, *port_number);
  return 0;
}
...
static s48_error_t
s48_new_socket_number (s48_word_t * result,
                       s48_arena_t arena,
                       s48_word_t * channel)
{
  *result = s48_socket_number (*channel);
  return 0;
}
...
static s48_error_t
s48_new_listen (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * channel)
{
  *result = s48_listen (*channel);
  return 0;
}
...
static s48_error_t
s48_new_accept (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * channel)
{
  *result = s48_accept (*channel);
  return 0;
}
...
static s48_error_t
s48_new_connect (s48_word_t * result,
                 s48_arena_t arena,
                 s48_word_t * channel,
                 s48_word_t * machine,
                 s48_word_t * port,
                 s48_word_t * retry_p)
{
  *result = s48_connect (*channel, *machine, *port, *retry_p);
  return 0;
}
...
static s48_error_t
s48_new_dup_socket_channel (s48_word_t * result,
                            s48_arena_t arena,
                            s48_word_t * channel)
{
  *result = s48_dup_socket_channel (*channel);
  return 0;
}
...
static s48_error_t
s48_new_close_socket_half (s48_word_t * result,
                           s48_arena_t arena,
                           s48_word_t * channel,
                           s48_word_t * input_p)
{
  *result = s48_close_socket_half (*channel, *input_p);
  return 0;
}
...
static s48_error_t
s48_new_get_host_name (s48_word_t * result,
                       s48_arena_t arena)
{
  *result = s48_get_host_name ();
  return 0;
}
...
static s48_error_t
s48_new_udp_receive (s48_word_t * result,
                     s48_arena_t arena,
                     s48_word_t * channel,
                     s48_word_t * buffer)
{
  *result = s48_udp_receive (*channel, *buffer);
  return 0;
}
...
static s48_error_t
s48_new_udp_send (s48_word_t * result,
                  s48_arena_t arena,
                  s48_word_t * channel,
                  s48_word_t * address,
                  s48_word_t * buffer,
                  s48_word_t * count)
{
  *result = s48_udp_send (*channel, *address, *buffer, *count);
  return 0;
}
...
static s48_error_t
s48_new_lookup_udp_address (s48_word_t * result,
                            s48_arena_t arena,
                            s48_word_t * name,
                            s48_word_t * port)
{
  *result = s48_lookup_udp_address (*name, *port);
  return 0;
}
