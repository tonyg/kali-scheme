...
static s48_error_t
new_posix_dup (s48_word_t * result,
               s48_arena_t arena,
               s48_word_t * channel,
               s48_word_t * new_mode)
{
  *result = posix_dup (*channel, *new_mode);
  return 0;
}
...
s48_error_t
new_posix_dup2 (s48_word_t * result,
                s48_arena_t arena,
                s48_word_t * channel,
                s48_word_t * new_fd)
{
  *result = posix_dup2 (*channel, *new_fd);
  return 0;
}
...
static s48_error_t
new_posix_pipe (s48_word_t * result,
                s48_arena_t arena)
{
  *result = posix_pipe ();
}
...
static s48_error_t
new_posix_close_on_exec_p (s48_word_t * result,
                           s48_arena_t arena,
                           s48_word_t * channel)
{
  *result = posix_close_on_exec_p (*channel);
  return 0;
}
...
static s48_error_t
new_posix_set_close_on_exec (s48_word_t * result,
                             s48_arena_t arena,
                             s48_word_t * channel,
                             s48_word_t * value)
{
  *result = posix_set_close_on_exec (*channel, *value);
  return 0;
}
...
static s48_error_t
new_posix_io_flags (s48_word_t * result,
                    s48_arena_t arena,
                    s48_word_t * channel,
                    s48_word_t * options)
{
  *result = posix_io_flags (*channel, *options);
  return 0;
}
...
s48_error_t
s48_new_enter_file_options (s48_word_t * result,
                            s48_arena_t arena,
                            int file_options)
{
  *result = s48_enter_file_options (file_options);
}
...
s48_error_t
s48_new_extract_file_options (int * result,
                              s48_arena_t arena,
                              s48_word_t * sch_file_options)
{
  *result = s48_extract_file_options (*sch_file_options);
  return 0;
}
