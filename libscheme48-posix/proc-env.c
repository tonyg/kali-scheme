...
static s48_error_t
new_posix_get_pid (s48_word_t * result,
                   s48_arena_t arena,
                   s48_word_t * parent_p)
{
  *result = posix_get_pid (*parent_p);
  return 0;
}
...
static s48_error_t
new_posix_set_sid (s48_word_t * result,
                   s48_arena_t arena)
{
  *result = posix_set_sid ();
  return 0;
}
...
static s48_error_t
new_posix_get_id (s48_word_t * result,
                  s48_arena_t arena,
                  s48_word_t * user_p,
                  s48_word_t * real_p)
{
  *result = posix_get_id (*user_p, *real_p);
  return 0;
}
...
static s48_error_t
new_posix_set_id (s48_word_t * result,
                  s48_arena_t arean,
                  s48_word_t * user_p,
                  s48_word_t * id)
{
  *result = posix_set_id (*user_p, *id);
  return 0;
}
...
static s48_error_t
new_posix_get_login (s48_word_t * result,
                     s48_arena_t arena)
{
  *result = posix_get_login ();
  return 0;
}
...
static s48_error_t
new_posix_get_env (s48_word_t * result,
                   s48_arena_t arena,
                   s48_word_t * name)
{
  *result = posix_get_env (*name);
}
...
static s48_error_t
new_posix_get_env_alist (s48_word_t * result,
                         s48_arena_t arena)
{
  *result = posix_get_env_alist ();
  return 0;
}
...
static s48_error_t
new_posix_get_groups (s48_word_t * result,
                      s48_arena_t arena)
{
  *result = posix_get_groups ();
  return 0;
}
...
static s48_error_t
new_posix_sys_name (s48_word_t * result,
                    s48_arena_t arena,
                    s48_word_t * which)
{
  *result = posix_sys_name (*which);
  return 0;
}
...
static s48_error_t
new_posix_get_terminal_pathname (s48_word_t * result,
                                 s48_arena_t arena)
{
  *result = posix_get_terminal_pathname ();
  return 0;
}
...
static s48_error_t
new_posix_tty_name (s48_word_t * result,
                    s48_arena_t arena,
                    s48_word_t * channel)
{
  *result = posix_tty_name (*channel);
  return 0;
}
...
static s48_error_t
new_posix_is_a_tty (s48_word_t * result,
                    s48_arena_t arena,
                    s48_word_t * channel)
{
  *result = posix_is_a_tty (*channel);
  return 0;
}
